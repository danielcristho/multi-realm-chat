...
class Chat:
	def __init__(self, REALM_IP, REALM_PORT):
		...
		self.known_realms = [('172.18.0.4', 11111)]
		...
		self.users['messi']={ 'nama': 'Lionel Messi', 'negara': 'Inggris', 'password': 'surabaya','incoming': {}, 'outgoing':{}, 'incoming_file' : {},  'group': [], 'realm': self.realm}
